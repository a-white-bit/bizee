# Bizee : 나만의 일정 관리 앱 서버

## 개요

> ### _**Bizee**_ 는 일정(Schedule)을 관리할 수 있는 *웹 애플리케이션 서버*입니다.
> 
...
> 
> API 기능만 동작하며, 테스트 시에는 [postman](https://web.postman.co/)같은 도구를 사용합니다.
> 
...
> 2. 수정, 삭제 API 요청(reqeust) 방식은 (param, query, body) 방법을 사용합니다.
